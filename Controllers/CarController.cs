...
namespace Clase5.Controllers
{
    public class CarController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Model,Year,Marc,Patent,Color")] Car car)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Model,Year,Marc,Patent")] Car car)
        {
            if (id != car.Id)
            {
                return NotFound();
